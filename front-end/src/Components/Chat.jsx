...
function Chat() {
  return (
    <div className='bg-mainBlack h-screen flex flex-col items-center justify center '>
      ...
      {/*Profiles Section */}
      <div className='rounded-xl border border-gray-300 opacity-25 bg-gradient-to-r from-opacity-80 to-opacity-85 from-black to-black flex flex-col items-center justify-center w-[30%] mr-[60%] h-[50%] mt-[-54%]'>
        {/*USER'S PROFILE */}
      </div>
      <div>
        {/*All profiles  */}
