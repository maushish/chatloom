        ...
        <div>
          <div className="relative min-h-screen flex flex-col bg-mainBlack">
            <div className='container flex flex-col items-center relative'>
              <div className='bg-black-gradient border border-gray-300 rounded-xl w-[800px] h-[700px] l absolute left-[800px] flex flex-col items-center justify-center top-40'>
                <nav>
