        ...
        <div>
          <div className="relative min-h-screen flex flex-col bg-mainBlack">
            <div className='container flex flex-col items-center relative'>
              <div className='bg-black-gradient border border-gray-300 rounded-xl w-[800px] md:w-[600px] h-[700px] md:h-[500px] l absolute left-[800px] flex flex-col items-center justify-center top-40 md:top-20'>
                <nav>
                  <AiFillVideoCamera color='#9DF3FF' size={30} className='absolute right-32 top-9'/>
                  <div className='absolute top-5 left-32 md:left-12'>
                ...
                <footer className='absolute bottom-10 flex flex-col items-center justify-center'>
                  <input className=' w-[240%] md:w-[150%] bg-chatBlack rounded-lg pl-3 text-white h-10' placeholder='Type your message here'></input>
                  <AiOutlineSend size={30} color='#9DF3FF' className='absolute left-80 md:left-[280px]'/>
                </footer>
              ...
              <img
                ...
                alt="Profile Picture"
                className="w-20 absolute left-[220px] top-[148px] md:top-[10px] z-20 object-cover rounded-full md:left-[60px]"
              />
              <div className='bg-customGreen w-40 h-[55px] z-1 rounded-3xl absolute left-[250px] top-40 md:top-5 md:left-[60px]'>
              ...
              <div className='bg-black-gradient border flex flex-col items-center justify-center border-gray-300 rounded-xl w-[350px] h-[500px] md:h-[500px] absolute left-[200px] md:left-[240px] top-80 md:top-20'>
